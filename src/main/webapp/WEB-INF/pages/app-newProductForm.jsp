    ...
    <h1>Add/Edit Product</h1>
        <form:form action="saveProduct" method="post" modelAttribute="product" class="form-horizontal" role="form">
        	...
        	<div class="form-group">
               ...
               <div class="col-sm-9">
               		<form:input path="categoryPath" cssClass="form-control" required="required"/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
               <label for="categoryID" class="col-sm-3 control-label" required="required">Product Category</label>
               <div class="col-sm-9">
